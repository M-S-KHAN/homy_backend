...
/**
 * Fetches user data from the specified API endpoint using GuzzleHttp.
 *
 * This function sends a GET request to the API. It expects the API to return
 * a JSON formatted string of users under the "users" key.
 *
 * @return array An associative array of users or an error message as an array.
 */
function fetchUsers()
{
    ...
    $apiUrl = 'http://localhost/api/users/get-users.php?user_id=' . $userId;
...
// Fetch the users using the fetchUsers function
$users = fetchUsers();
...
// Proceed to use $users data as needed
?>
        ...
        <div class="sidebar-scroll">
            <nav>
                <ul class="nav">
                    ...
                    <li><a href="users.php" class="active"><i class="lnr lnr-users"></i> <span>Users</span></a></li>
                </ul>
            </nav>
        </div>
    </div>
